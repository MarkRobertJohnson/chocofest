...
function Prepare-OtterServerForDemo {
  ...
  Invoke-WebRequest -Uri http://s16-dev:8626/api/infrastructure/servers/update/s16-prod?key=ChocoFest -Method POST -Body '{"roles": [], "drift": "reportOnly","raftId": "3", "raft": "Prod"}'
...
Reset-Branch -Branch master -Path $RepoPath -Commit faf76852ddf37a035f1b8524a3b17264e70e3b65
